class SuperGoalCard extends ExtraBlinkCard{
	...
	protected onAdd(event: egret.Event) {
		...
		this.winTipTx = Com.addLabelAt( this, 245, GameCardUISettings.cardTextRect.y, GameCardUISettings.cardTextRect.width, GameCardUISettings.cardTextRect.height, GameCardUISettings.cardTextRect.height, false, true );
		...
		this.winTx = Com.addLabelAt( this, 325, GameCardUISettings.betTextRect.y, 200, GameCardUISettings.betTextRect.height, GameCardUISettings.betTextRect.height, false, true );
