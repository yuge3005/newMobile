class Turbo90 extends V2Game{
	...
	public constructor( assetsPath: string ) {
        ...
        GameCardUISettings.showTitleShadow = new egret.GlowFilter(0, 1, 2, 2, 4 );
        CardGridColorAndSizeSettings.defaultNumberSize = 55;
        GameCardUISettings.gridOnTop = false;
    ...
    protected init(){
        ...
        this.arrowArea = new CardArrowLayer( MDS.mcFactory, "arrowAnimationInT90", this.cardPositions, new egret.Point( -52, 65 ), 72 );
