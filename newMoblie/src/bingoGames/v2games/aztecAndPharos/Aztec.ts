class Aztec extends AztecPharosSuper{
	...
	public constructor( assetsPath: string ) {
        ...
        TowerGrid.blink1PicName = "StoneGreen";
        TowerGrid.blink2PicName = "StoneRed";
        TowerGrid.defaultBgPicName = "StoneDefault";
        TowerGrid.onEffBgPicName = "StoneYellow";
        TowerGrid.linePicName = "StoneRed";
