class CopaMarkPenBar extends egret.DisplayObjectContainer{
    ...
    private markPen1: egret.DisplayObjectContainer;
    private markPen2: egret.DisplayObjectContainer;
    ...
    public constructor() {
        ...
        this.markPen1 = this.buildAPen();
        this.markPen2 = this.buildAPen();
    ...
    private buildAPen(): egret.DisplayObjectContainer{
        let pen: egret.DisplayObjectContainer = new egret.DisplayObjectContainer;
        let sq: egret.Sprite = new egret.Sprite;
        GraphicTool.drawRect( sq, new egret.Rectangle( 0, 0, CardGridColorAndSizeSettings.gridSize.x, CardGridColorAndSizeSettings.gridSize.y ), 0xCCCC00, false, 0.25 );
        pen.addChild( sq );
        let penBitmap: egret.Bitmap = Com.addBitmapAt( pen, BingoMachine.getAssetStr( "icon_mark_big" ), 70, -40 );
        penBitmap.scaleX = penBitmap.scaleY = 1.43;
        Com.addObjectAt( this, pen, 0 , 0 );
        return pen;
    }
