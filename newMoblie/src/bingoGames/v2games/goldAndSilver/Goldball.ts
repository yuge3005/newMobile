class Goldball extends GoldSilverSuper{
	...
	public constructor( assetsPath: string ) {
        ...
        // GameCard.cardTexPosition = new egret.Point( 15, 2 );
        // GameCard.betTexPosition = new egret.Point( 130, 2 );
        // GameCard.texSize = 16;
        GameCard.texColor = 0xFFFFFF;

        CardGrid.defaultBgColor = 0xFCF3D6;
        CardGrid.defaultNumberSize = 23;

        CardGrid.blinkColors1 = 0x66AF00;
	    CardGrid.blinkColors2 = 0xDE4200;
	}
