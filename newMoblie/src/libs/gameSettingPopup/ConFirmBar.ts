class ConFirmBar extends egret.Sprite{
	public constructor( size: egret.Point ) {
		...
		let title: TextLabel = Com.addLabelAt( this, 100-610, 75-320, 910, 76, 76 );
        ...
        let btTx1: egret.TextField = Com.addTextAt( this, 0, 0, 20, 72, 72 );
        ...
        let btTx2: egret.TextField = Com.addTextAt( this, 0, 0, 20, 72, 72 );
