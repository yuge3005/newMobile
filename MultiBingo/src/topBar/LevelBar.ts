class LevelBar extends egret.DisplayObjectContainer{
	...
	private addHead(){
		...
		if ( PlayerConfig.player("facebook_id") && PlayerConfig.player("facebook_id") != "" ) FacebookBitmap.downloadBitmapDataByFacebookID(PlayerConfig.player("facebook.id"), 100, 100, MDS.onUserHeadLoaded.bind( this, this.userHead, 95 ), this);
